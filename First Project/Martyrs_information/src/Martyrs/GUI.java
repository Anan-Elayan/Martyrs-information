...
public class GUI extends Pane {
	...
	Stage mainStage;
    Scene scene;
	static DoublyLinkedList data = new DoublyLinkedList();
	...
	public GUI(Stage primaryStage) {
			...
			try {
				...
				while (input.hasNextLine()) {
					...
					try {
						...
						node = data.search(location);
						NodeSigleLinkedList newNodeSingle = new NodeSigleLinkedList(
								new Martyrs(name, age, date, gender, status));
		...
		primaryStage.show();/// Name,Age,Event location - District,Date of death,Gender
